...
print(process_conversation(
    ["Person 1: What is your interest?", "Person 2: I like to play chess.", "Person 1: Where do you like to play chess?", "Person 2: I like to play chess online at chess.com."]))
